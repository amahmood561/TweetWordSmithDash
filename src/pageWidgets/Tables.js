...
export const TweetsTable = (props) => {
    const totalTransactions = props.tweets.length;
    const TableRow = (props) => {
        return (
            <tr>
                <td>
          ...
          <span className="fw-normal">
            {props.text}
                ...
                <td>
          <span className="fw-normal">
            {props.public_metrics.like_count}
          </span>
                </td>
                <td>
          <span className={`fw-normal`}>
            {props.public_metrics.qoute_count}
          </span>
                </td>
                <td>
          <span className={`fw-normal`}>
            {props.public_metrics.reply_count}
          </span>
                </td>
                <td>
         <span className={`fw-normal`}>
            {props.public_metrics.retweet_count}
          </span>
                </td>
                <td>
                <Dropdown as={ButtonGroup}>
            ...
            <Card.Body className="pt-0">
                <Table hover className="user-table align-items-center">
                    ...
                    <tr>
                        ...
                        <th className="border-bottom">Tweet</th>
                        <th className="border-bottom">Like Count</th>
                        <th className="border-bottom">Qoute Count</th>
                        <th className="border-bottom">Reply Count</th>
                        <th className="border-bottom">Retweet Count</th>
                        <th className="border-bottom">Action</th>
                    </tr>
                    </thead>
                    <tbody>
                    {props.tweets.length > 0  ? props.tweets.map(t => <TableRow key={`transaction-${t.id}`} {...t} />): ''}
